...
document.addEventListener('DOMContentLoaded', () => { 
    ...
    const baseDeDatos = [
        {
            id: 1,
            nombre: 'Raqueta de tenis (Semi-pro)',
            precio: 500000,
            imagen: 'assets/img/raquetadetenis.webp',
            categoria: 'tenis'
        },
        {
            id: 2,
            nombre: 'Zapatos de tenis',
            precio: 220000,
            imagen: 'assets/img/zapatosdetenis.webp',
            categoria: 'tenis'
        },
        {
            id: 3,
            nombre: 'Conjunto de tenis (Hombre - Mujer)',
            precio: 340000,
            imagen: 'assets/img/conjuntoderopatenis.webp',
            categoria: 'tenis'
        },
        {
            id: 4,
            ...
            precio: 300000,
            imagen: 'assets/img/balondefutbol.webp',
            categoria: 'futbol'
        },
        {
            id: 5,
            nombre: 'Conjunto de futbol (Hombre - Mujer)',
            precio: 400000,
            imagen: 'assets/img/conjuntoderopafutbol.webp',
            categoria: 'futbol'
        },
        {
            id: 6,
            ...
            precio: 280000,
            imagen: 'assets/img/zapatosdefutbol.webp',
            categoria: 'futbol'
        },
        {
            id: 7,
            nombre: 'Zapatos de basketball',
            precio: 250000,
            imagen: 'assets/img/zapatosdebasketball.webp',
            categoria: 'basketball'
        },
        {
            id: 8,
            nombre: 'Conjunto de basketball (Hombre - Mujer)',
            precio: 360000,
            imagen: 'assets/img/conjuntoderopabasketball.webp',
            categoria: 'basketball'
        },
        {
            id: 9,
            nombre: 'Balon de basketball',
            precio: 150000,
            imagen: 'assets/img/balondebasketball.webp',
            categoria: 'basketball'
        }
    ];
